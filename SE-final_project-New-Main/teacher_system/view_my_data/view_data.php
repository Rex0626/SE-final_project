                        ...
                        <div class="work-item">
                            ...
                            <div class="work-links">
                                <?php if (!empty($work['CodeLink'])): ?>
                                    <a href="<?php echo htmlspecialchars($work['CodeLink']); ?>" target="_blank" style="background-color: #B39870;">查看程式碼</a>
                                <?php endif; ?>
                                <?php if (!empty($work['VideoLink'])): ?>
                                    <a href="<?php echo htmlspecialchars($work['VideoLink']); ?>" target="_blank" style="background-color: #B39870;">觀看影片</a>
                    </div>
                                <?php endif; ?>
