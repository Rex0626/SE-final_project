...
<head>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    tbody tr:hover { background:rgba(225, 198, 168,0.3); }
...
<body>
  <!-- 回主選單按鈕 -->
  <a href="student_system.html" class="back-btn">學生主選單</a>
        ...
        <div class="card-body">
          <?php if (count($list)): ?>
            <table>
              <thead>
                <tr>
                  <th style="background: #69503F; color: #FFF9F4;">#</th>
                  <th style="background: #69503F; color: #FFF9F4;">評審者</th>
                  <th style="background: #69503F; color: #FFF9F4;">分數</th>
                  <th style="background: #69503F; color: #FFF9F4;">評語</th>
                  <th style="background: #69503F; color: #FFF9F4;">評審時間</th>
                </tr>
              </thead>
              <tbody>
