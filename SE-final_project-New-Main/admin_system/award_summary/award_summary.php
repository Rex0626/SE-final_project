...
if (!isset($_GET['competition_id'])) {
    ...
    <body style="background:#FFF9F4; padding: 30px;">
    <div class="container">
        ...
        <form method="get" class="text-center">
            ...
            <button type="submit" class="btn btn-primary" style="border: none;">查看評審結果</button>
        </form>
    </div>
    </body>
    </html>
...
<html lang="zh-Hant">
    ...
    <body style="background-color: #FFF9F4;">
            ...
            <div id="scoresView">
                <table id="scoreTable" class="table table-striped table-bordered bg-white">
                    ...
                    <tr>
                        ...
                        <th style="background: #221F1F;">作品名稱</th>
                        <th style="background: #221F1F;">評審姓名</th>
                        <th style="background: #221F1F;">分數</th>
                        <th style="background: #221F1F;">評語</th>
                    </tr>
                    </thead>
        ...
        <div class="nav-buttons">
            ...
            <a href="./select_competition.php" class="btn btn-secondary">返回</a>
        </div>
