...
<head>
    ...
    <style>
        body { background-color: #FFF9F4; font-family: Arial, sans-serif; }
...
<body>
    <div class="container">
        ...
        <form method="POST" action="publish_selected_to_homepage.php">
            <table class="table table-bordered text-center">
                <thead class="thead-dark">
                    <tr>
                        <th style="background: #221F1F;"><input type="checkbox" onclick="toggleAll(this)"></th>
                        <th style="background: #221F1F;">標題</th>
                        <th style="background: #221F1F;">年份</th>
                        <th style="background: #221F1F;">上傳者 Email</th>
        ...
        <div class="text-center mt-3">
            <?php if ($page > 1): ?>
                <a href="?page=<?= $page - 1 ?>" class="btn btn-outline-primary" style="color: #221F1F;">上一頁</a>
            <?php endif; ?>
            <?php if ($page < $totalPages): ?>
                <a href="?page=<?= $page + 1 ?>" class="btn btn-outline-primary" style="color: #221F1F;">下一頁</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
