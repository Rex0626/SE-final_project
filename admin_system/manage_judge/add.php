...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($http_status === 201) {
        echo "<script>alert('✅ 評審新增成功！'); window.location.href = './main.php';</script>";
        exit();
    } else {
...
<body>
    <div class="container">
        ...
        <form action="add.php" method="POST">
            ...
            <button type="submit" class="btn btn-primary btn-block">➕ 新增評審</button>
        </form>

        <div class="text-center mt-3">
            <a href="./main.php" class="btn btn-secondary">返回評審管理介面</a>
        </div>
    </div>
</body>
</html>
